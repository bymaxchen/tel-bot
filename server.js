...
const CONFIG = {
  ...
  GPT_PROMPT:
    "基于该背景扩展，生成全身照；图片人物是一个不知名的成年女性；人物不一定需要站着，也可以坐着，你寻一个最合适的姿势；不要修改人物的五官、长相、耳饰、项链、妆容、头部角度、发型、发色、脸部角度、脸部光影；服装是白色T恤和牛仔短裤,赤脚；如果她没戴帽子，不要给她戴帽子",
};
...
const MODES = {
  mode1: { label: "直接脱衣", useGpt: false, twoImages: false, webappId: OLD_WEBAPP_ID, cost: 1, prompt: "全部去衣；不要修改人物的五官、长相、耳饰、项链、妆容、头部角度、发型、发色、脸部角度、脸部光影" },
  mode2: { label: "直接换衣", useGpt: false, twoImages: true, webappId: NEW_WEBAPP_ID, cost: 1 },
  mode3: { label: "扩图脱衣", useGpt: true, twoImages: false, webappId: OLD_WEBAPP_ID, cost: 2, prompt: "全部去衣；不要修改人物的五官、长相、耳饰、项链、妆容、头部角度、发型、发色、脸部角度、脸部光影" },
